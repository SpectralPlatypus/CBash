...
namespace Sk {
	...
	uint32_t ALCHRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
	{
		...
		case 14: //keywords
			...
			case 1: //fieldSize
				return (uint32_t)KWDA.value.size();
			default:
				return UNKNOWN_FIELD;
			}
			return UNKNOWN_FIELD;
		...
		case 35: //effects
			...
			case 5: //conditions
				...
				case 3: //compValue
					...
					case 2: //WhichType
						return Effects.value[ListIndex]->CTDA.value[ListX2Index]->CTDA->IsUseGlobal() ? FORMID_FIELD : FLOAT32_FIELD;
					default:
						return UNKNOWN_FIELD;
					}
					return UNKNOWN_FIELD;
				...
				case 9: //reference
					...
					case 0: //fieldType
						return UNKNOWN_OR_FORMID_OR_UINT32_FIELD;
					case 2: //WhichType
						return Effects.value[ListIndex]->CTDA.value[ListX2Index]->CTDA->IsResultOnReference() ? FORMID_FIELD : UINT32_FIELD;
					default:
						return UNKNOWN_FIELD;
					}
					return UNKNOWN_FIELD;
			...
			case 11: //altTextures
				...
				case 1: //name
					...
					if (FieldValue != NULL)
					{
						...
						strncpy(Destructable->Stages.value[ListIndex]->DMDS.MODS[ListX2Index]->name, (char *)FieldValue, ArraySize);
					}
					break;
				case 2: //texture
