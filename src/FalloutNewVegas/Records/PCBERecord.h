...
namespace FNV
{
class PCBERecord : public FNVRecord //Placed Grenade
    {
    private:
        enum xespFlags
            {
    ...
    public:
        ...
        PCBERecord(unsigned char *_recData=NULL);
        PCBERecord(PCBERecord *srcRecord);
        ~PCBERecord();
        ...
        bool operator ==(const PCBERecord &other) const;
        bool operator !=(const PCBERecord &other) const;
